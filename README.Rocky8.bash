...
kernel_shmall=`echo $(expr $(getconf _PHYS_PAGES) / 2)`
kernel_shmmax=`echo $(expr $(getconf _PHYS_PAGES) / 2 \* $(getconf PAGE_SIZE))`

#The sysctl.conf parameters listed in this topic are for performance, optimization, and consistency
